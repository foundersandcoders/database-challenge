...
Each challenge has associated unit tests. You can either run all the tests with `npm test`, or each individual challenge's tests with `npm run test:products`, `npm run test:customers` etc.
...
<details>
<summary><code>customers</code></summary>
...
## Stretch goal: calculate stock value
...
## Stretch goal: format currencies
